...
- 🌟🌟🌟 [carlospolop/hacktricks](https://github.com/carlospolop/hacktricks):
  Welcome to the page where you will find each trick/technique/whatever I have
  learnt in CTFs, real life apps, and reading researches and news.
...
- [litespeedtech/lsquic](https://github.com/litespeedtech/lsquic): LiteSpeed
...
- [microsoft/reverse-proxy](https://github.com/microsoft/reverse-proxy): A
  toolkit for developing high-performance HTTP reverse proxy applications.
...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne): A Smart
  Ethernet Switch for Earth <https://zerotier.com>
