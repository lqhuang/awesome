...
- [sqliteai/sqlite-vector](https://github.com/sqliteai/sqlite-vector): SQLite-Vector is a cross-platform, ultra-efficient SQLite extension that brings vector search capabilities to your embedded database. <https://sqlite.ai/>
- [sqliteai/sqlite-sync](https://github.com/sqliteai/sqlite-sync): SQLiteSync is a local-first SQLite extension using CRDTs for seamless, conflict-free data sync and real-time collaboration across devices. <https://sqlite.ai>
