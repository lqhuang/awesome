...
- [returntocorp/semgrep](https://github.com/returntocorp/semgrep): Lightweight static analysis for many languages. Find bug variants with patterns that look like source code. <https://semgrep.dev>
  - [apiiro/malicious-code-ruleset](https://github.com/apiiro/malicious-code-ruleset): Focused malicious code detection ruleset, with a high protection-to-noise ratio <https://apiiro.com/blog/guard-your-codebase-practical-steps-and-tools-to-prevent-malicious-code/>
  - [apiiro/PRevent](https://github.com/apiiro/PRevent): Prevent merging of malicious code in pull requests <https://apiiro.com/blog/guard-your-codebase-practical-steps-and-tools-to-prevent-malicious-code/>
